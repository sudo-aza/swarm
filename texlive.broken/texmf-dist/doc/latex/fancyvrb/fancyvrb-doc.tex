...
\FBoxPackage{} package,  Section 11 of \cite{ctan-fancybox}. It offers six kinds
...
the `\textsf{LGrind}'~\cite{ctan-lgrind} system, currently maintened by Michael
\textsc{Piefel}, and the `\textsf{listings}'~\cite{ctan-listings} package from
Carsten \textsc{Heinz}.
