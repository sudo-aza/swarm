...
%
% This demo uses only 3 lazy-loaded packages (hyperref, amsmath, enumitem)
...
% booktabs loaded lazily by \swarmtoprule on first table use (section 4)
...
\begin{tipblock}
  ...
  flag is required unless you use \code{\textbackslash useminted}.
\end{tipblock}
...
Escaped code with special characters: \codeesc{text_with_underscores}.
...
API-compatible with swarmbeauty: accepts \code{[optional name]\{label\}}.
